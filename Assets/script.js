...
let questionArray = [
    { "question": "Comment š'appelle ton partenaire?",
        "answers": ["Fonds", "Fund", "Finanziare", "tamwil"],
        "correctAnswer": 0
    },

    { "question": "Anata no pātonā ga anata ni ai o kokuhaku suru no wa nan'nichidesu ka?",
        "answers": ["Getsuyōbi", "Kayōbi", "Suiyōbi", "Doyōbi"],
        "correctAnswer": 3
    },

    { "question": "Em que data você e seu parceiro se conheceram?",
        "answers": ["nove", 
            "dez", 
            "onze", 
            "Um"
    ...
    { "question": "Partnerinizle nerede tanıştınız?",
        "answers": ["Dağ", "Ofis", "Sahil", "kırsal"],
        "correctAnswer": 1
    },

    { "question": "Wie lange sind Sie und Ihr Partner schon in einer Beziehung?",
        "answers": ["ein Jahr", "drei Monate", "fünf Monate", "sieben Monate"],
        "correctAnswer": 2
    },
];
...
function initialQuiz() {
    ...
    quizLayout.innerHTML = "Pertanyaan disini akan menguras Tenaga, Pikiran , Perasaan dan akan mengandung bawang, jadi tolong jawab dengan jujur serta jangan lupa untuk berdoa sembelum menjawab dari pertanyaan - pertanyaan berikut :)";
...
startBtn.addEventListener("click", function () {
    ...
    // quizTitle.textContent="Anniversary Quiz";
...
function checkAnswer(event) {
    ...
    if (event.target.matches("button")) {
        ...
        // console.log("questionNumber => " + questionNumber + "questionArray.length => "  + questionArray.length)
        // if (questionNumber == 5) {
...
function youGotAHighScore() {
    ...
    quizTitle.textContent="Happy Anniversary 5 Month";
    quizLayout.innerHTML = "Happy Anniv Cintaku, Sebelumnya aku mau minta maaf karna cuekkin kamu seharian, karna aku tau bahwa hari ini adalah hari anniv kita yg 5 bulan, pelajaran di bulan ini adalah kalau ada yang kurang sreg bilang jangan di pendem sendiri dan jangan overthingking semua udah ada yang nagtur masalah rezeki, jadi jgn ambil pusing yang terpenting kita tetap berusaha walaupun dalam keadaan sulit. aku berharap di bulan ini doa dan penantian kita terkait rapelan bisa segera terwujud agar kita bisa bertumbuh bersama-sama. sekali lagi aku minta maaf ya cinta, aku emang sengaja mau ngucapin aniv di menit-menit akhir. Selamat Malam Jumat :)";
}
